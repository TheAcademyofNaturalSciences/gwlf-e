...
def CalcCN(z, i, Y, j):
    ...
    if z.Water[Y][i][j] < 0.05:
        ...
        for l in range(z.NRur, z.NLU):
                    ...
                    if z.Grow_Factor[i] > 0:
                        ...
                        if z.AMC5_isolate[Y][i][j] >= 5.33:
                            ...
                            z.CNumImperv = z.CNI[1][l] + (z.CNI[2][l] - z.CNI[1][l]) * (
                                        z.AMC5_isolate[Y][i][j] - 3.56) / 1.77
                            z.CNumImpervStorage[Y][i][j][l] = z.CNumImperv
                    else:
                        # Dormant season
                        if z.AMC5_isolate[Y][i][j] >= 2.79:
                            ...
                            z.CNumImperv = z.CNI[1][l] + (z.CNI[2][l] - z.CNI[1][l]) * (
                                        z.AMC5_isolate[Y][i][j] - 1.27) / 1.52
                            z.CNumImpervStorage[Y][i][j][l] = z.CNumImperv
                else:
                    z.CNumImperv = z.CNI[2][l]
                    z.CNumImpervStorage[Y][i][j][l] = z.CNumImperv
            ...
            # if z.UrbAreaTotal > 0:
            #     z.UrbanQTotal_1 += ((z.QrunI[l] * (z.Imper[l] * (1 - z.ISRR[lu]) * (1 - z.ISRA[lu]))
...
def BasinWater(z, i, Y, j):
    ...
    if z.UrbAreaTotal > 0:
        z.UrbanQTotal_2 = z.UrbanQTotal_1[Y][i][j] * z.UrbAreaTotal / z.AreaTotal
    else:
        z.UrbanQTotal_2 = 0
    ...
    z.QTotal = z.UrbanQTotal_2 + z.RuralQTotal[Y][i][j]
    # z.QTotal = z.UrbanQTotal[Y][i][j] + z.RuralQTotal[Y][i][j]
    ...
    z.UrbanRunoff[Y][i] += z.UrbanQTotal_2
